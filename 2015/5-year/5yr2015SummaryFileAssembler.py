...
def get_summary_data_dict(seq, EorM, geo):
    ...
    inFileName = os.getcwd() + "/data/2015_5yr_All_Geographies_Not_Tracts_Block_Groups/group1/" + EorM.lower() + "20155" + geo + number + "000.txt"
    ...
    with open(outFileName, 'w+', newline='') as outFile:
        ...
        for state in allStates:
            ...
            if len(alikeSeqs) == 1:
                ...
                inFileName = os.getcwd() + "/data/2015_5yr_All_Geographies_Not_Tracts_Block_Groups/group1/" + EorM.lower() + "20155" + state + number + "000.txt"
                with open(inFileName, 'r', newline='') as inFile:
                    reader = csv.reader(inFile, delimiter=',', quotechar='"')
                    row = next(reader)
                    summaryData += row[6:]
